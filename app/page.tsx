        ...
        <main className="flex flex-col gap-48">
                ...
                <div className="flex flex-col gap-12">
                    ...
                    <div className="flex gap-8">
                        <div className="space-y-4 break-keep text-xl leading-8">
                            <p>
                                안녕하세요. 제 이름은 문희이고, 저는 살아 있는 화면을 만드는 작업을 좋아합니다. 웹 개발에 대한 관심은 지난 2022년부터 시작되었습니다. 막연하게 IT
                                기업 입사를 꿈꾸며 수강한 프론트엔드 수업에서 HTML & CSS로 직접 화면을 구현하고 JavaScript로 UI 로직을 만드는 일에 흥미를 가지게 되었습니다.
                            </p>
                            <p>
                                                                ...
                                                                <dl className="flex flex-col gap-4">
                                                                            ...
                                                                            <ol className="upper-al list-[upper-alpha] space-y-3 pl-5">
                                                                                <li>
                                                                                    ...
                                                                                    <ul className="list-disc pl-5 text-base">
                                                                                        <li>
                                                                                            react-hook-form와 zod을 활용한 Dynamic Form 구현 (e.g 이름 항목 추가, 성별 항목 삭제,
                                                                                            증명 사진 항목 추가 등)
                                                                                        </li>
                                                                                        <li>tanstack/table의 Editable table을 사용하여 row의 순서를 DnD로 제어</li>
                                                                                        <li>
                                                                                            valueType을 VARCHAR/DATE/SELECT 등으로 구분하고 각 valueType에 최소 길이와 같은 제약
                                                                                            사항을 추가
                                                                                        </li>
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    <ul className="list-disc pl-5 text-base">
                                                                                        ...
                                                                                        <li>
                                                                                            승인된 인증서는 ENS가 발급되는데, <code>BASE_URL/ens/ensName</code>로 생성된 QR을
                                                                                            스캔하고 verify API를 통해 증명 결과를 화면에 표시
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li>
                                                                                    ...
                                                                                    <ul className="list-disc pl-5 text-base">
                                                                                        <li>
                                                                                            승인된 인증서의 신청자 이름 및 발급 일자 등을 조합하여 이미지 프린트 미리보기 및 프린트
                                                                                            기능 구현
                                                                                        </li>
                                                                    ...
                                                                    <div className="space-y-1">
                                                                        ...
                                                                        <dd className="text-lg font-bold">
                                                                            React, TypeScript, Tanstack/query, TailwindCSS, Shadcn/ui, nextui, vite
                                                                        </dd>
                                                                    </div>
                                                                    <div className="space-y-1">
                                                                        <dt>업무 기간</dt>
                                                                            ...
                                                                            <ol className="upper-al list-[upper-alpha] space-y-3 pl-5">
                                                                                <li>
                                                                                    ...
                                                                                    <ul className="list-disc pl-5 text-base">
                                                                                        ...
                                                                                        <li>
                                                                                            앱의 언어 정보를 전달하기 위해 window.postMessage 등 Window 객체와 'message' 이벤트를
                                                                                            통한 RN - React.js 통신
                                                                                        </li>
                        ...
                        <ul>
                            <li>
                                <div>
                                    ...
                                    <div>React, nodejs, scss, vite, vercel, mongodb</div>
                                    <div>
            ...
            <section>
                <div>
                    ...
                    <div>
                        <p>Get In Touch</p>
                        <p>현재는 새로운 기회를 찾고 있지 않지만 받은 편지함은 항상 열려 있습니다. 질문이 있으시거나 그냥 인사하고 싶으신가요? 최선을 다해 답변해 드리겠습니다!</p>
                    </div>
